...
export default function CurrentWeather({ fetchLocation, locationNames, }: CurrentWeatherProps) {
  ...
  return (
    <div className="box-border content-stretch flex flex-col gap-2 items-start justify-start px-3 py-2 relative shrink-0 w-full text-[#0f2a44]">
      {/* 위치 정보 */}
      <div className="content-stretch flex gap-1.5 items-center justify-center relative rounded-full shrink-0">
        <div className="font-bold leading-none not-italic relative shrink-0 text-[#3d5570] text-base text-center text-nowrap tracking-[-0.4px]">
        ...
        <div className="bg-[#fbfaf7] relative rounded-full shrink-0 size-6 cursor-pointer" onClick={fetchLocation}>
          ...
          <div className="absolute border border-[#d9d1c6] border-solid inset-0 pointer-events-none rounded-full" />
        </div>
      </div>
      ...
      {weather ? (
        <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
          ...
          <div className="basis-0 box-border content-stretch flex gap-4 grow items-center justify-start min-h-px min-w-px pl-0 pr-5 py-0 relative shrink-0">
            <div className="font-serif font-semibold leading-none not-italic relative shrink-0 text-[#0f2a44] text-[52px] text-center text-nowrap tracking-[-1.25px]">
            ...
            <div className="basis-0 content-stretch flex flex-col gap-[3px] grow items-start justify-start leading-none min-h-px min-w-px not-italic relative shrink-0">
              <div className="content-stretch flex items-center justify-between relative shrink-0 text-center w-[146px]">
                <div className="font-bold relative shrink-0 text-[#0f2a44] text-xl text-nowrap tracking-[-0.5px]">
                  <p className="leading-normal whitespace-pre">{getSkyStatusText(skyStatus)}</p>
                </div>
                <div className="font-extrabold relative shrink-0 text-[#3d5570] text-[18px] tracking-[-0.45px] w-[105px]">
                  <p className="leading-normal not-italic">
                    {
                        tempMin != null && tempMax != null ? (
                          <>
                            <span>{`${Math.round(tempMin)}°`} / </span>
                            <span className="text-[#3d5570]">{`${Math.round(tempMax)}°`} </span>
                          </>
                        ) : ''
                    }
                  </p>
              ...
              <div className="font-bold relative shrink-0 text-[#7a8ca3] text-sm tracking-[-0.35px] w-[105px]">
          ...
          <div className="box-border content-stretch flex gap-5 items-center justify-start pl-5 pr-0 py-0 relative shrink-0">
            <div className="absolute border-[#d9d1c6] border-l border-solid inset-0 pointer-events-none" />
            ...
            <div className="content-stretch flex gap-2.5 items-start justify-start relative shrink-0">
              ...
              <div className="content-stretch flex flex-col gap-1 items-start justify-start leading-none not-italic relative shrink-0 w-[97px]">
                <div className="font-bold relative shrink-0 text-[#0f2a44] text-base tracking-[-0.4px] w-full">
                  <p className="leading-normal">{humidity != null ? Math.round(humidity) + '%' : '-'}</p>
                </div>
                <div className="font-semibold relative shrink-0 text-[#7a8ca3] text-sm tracking-[-0.35px] w-full">
                  <p className="leading-normal">
